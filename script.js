...
function question1(){
  ...
  document.getElementById("q1stat").innerHTML = "Data has been saved!!";
}
...
function question2(){
  ...
  document.getElementById("q2stat").innerHTML = "Saved!!";
}
...
function question3(){
  ...
  document.getElementById("q3stat").innerHTML = " saved!!";
}
...
function question4(){
  ...
  document.getElementById("q4stat").innerHTML = " saved!!";
}
...
function question5(){
  ...
  document.getElementById("q5stat").innerHTML = " saved!!";
}
